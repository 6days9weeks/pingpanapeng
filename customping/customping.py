...
class CustomPing(commands.Cog):
    ...
    async def ping(self, ctx):
        ...
        e = discord.Embed(title="Pinging..", description=f"<a:loading:759075501704478733> Overall Latency: {totalPing}ms")
        ...
        e.description = e.description + f"\n<:discord:759071945232220241> Discord Latency: {botPing}ms"
        await asyncio.sleep(0.25)
        try:
